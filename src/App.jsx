      ...
      <div className="lock-box" style={{ width: "100%", maxWidth: 340, textAlign: "center" }}>
        ...
        <div className={shake ? "shake" : ""}>
          ...
          <button onClick={attempt}
            style={{ width: "100%", background: "#f97316", border: "none", borderRadius: 10, padding: "14px", color: "#000", fontSize: 13, fontFamily: "'DM Mono',monospace", letterSpacing: ".1em", textTransform: "uppercase", cursor: "pointer", fontWeight: "bold" }}>
            Enter →
          </button>
        </div>
...
export default function App() {
  ...
  const loadAll = useCallback(async () => {
    try {
      const [countRows, fbRows] = await Promise.all([
        sbGetAll("bus_counts"),
  ...
  const submitFeedback = async (time, fbId) => {
    ...
    await sbUpsert("bus_feedbacks", key, { data: updated });
  };
